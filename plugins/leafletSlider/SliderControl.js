L.Control.SliderControl = L.Control.extend({
    ...
    extractTimestamp: function(time, options) {
        ...
        a = time.substr(options.startTimeIdx, options.startTimeIdx + options.timeStrLength);
		$('#startDate').html(a);
		//alert(a);
		return a;
    },
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:200px" onmouseup="changeDate(this)"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>');
