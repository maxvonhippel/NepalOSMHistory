...
var area = d3.area()
	...
	.y0(height)
	.y1(function(d) { return y(d.new_features); });

var area2 = d3.area()
	.curve(d3.curveMonotoneX)
	.x(function(d) { return x2(d.date); })
	.y0(height2)
	.y1(function(d) { return y2(d.new_features); });
...
d3.csv("data/newedit.csv", type, function(error, data) {
